...
public abstract class Device implements Parcelable {
  ...
  private static Device create(String id, String name, String category, Bounds portOffset, Bounds portSize, Bounds realSize,
      List<String> productIds) {
    return new AutoValue_Device(id, name, category, portOffset,
  ...
  public static class Builder {
    ...
    public Device build() {
      return create(id, name, category, portOffset, portSize,
          realSize, productIds);
    }
  }
}
